        ...
        <div class="col-md-12 d-flex justify-content-center">
            @foreach ($series as $serie)
                @if ($serie->name == 'Finale')
                    <div class="final-image-container d-flex flex-column align-items-center">
                        <div class="d-flex">
                            <img src="{{ asset($serie->team_1->team_photo) }}" class="final-image"
                                alt="{{ $serie->team_1->name }}">
                            <img src="{{ asset($serie->team_2->team_photo) }}" class="final-image"
