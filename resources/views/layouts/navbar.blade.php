<!--Navbar-->
<nav class="navbar navbar-expand-lg fixed-top" style="background-color: #fffcdc; padding: 0 15px;">
        ...
        aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body d-flex flex-column flex-lg-row p-4 p-lg-0">
                <ul class="navbar-nav justify-content-lg-start fs-5 flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-2" href="{{ route('games.index') }}">Series</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-2" href="{{ route('teams.index') }}">Teams</a>
                    </li>
                    <li class="nav-item">
