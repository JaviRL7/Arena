                ...
                <div class="container-fluid" >
                    <div class="table-responsive">
                        <div class="custom-div">
                            <img src="{{ asset($serie->competition->logo) }}" alt="{{ $serie->competition->name }}" class="w-auto h-40">
                            <h2>{{ $serie->competition->name }}</h2>
                            <h2>{{ $serie->name }}</h2>
                            <h2>{{ $serie->date }}</h2>
                            <h2>{{ $serie->type }}</h2>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#editSerieModal" class="btn btn-primary d-block mb-2" style="float: right;">Edit serie</a>                        </div>
