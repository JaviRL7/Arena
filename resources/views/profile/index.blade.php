            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ asset('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 position-relative modal_user_photo">
                            <!-- Contenedor de la foto de perfil -->
                            <div style="position: relative; display: inline-block;">
                                <img src="{{ asset(Auth::user()->user_photo) }}" alt="Foto de perfil"
                                    class="modal-user-photo" style="border-radius: 50%; width: 100px; height: 100px;">

                                <!-- Nueva imagen de add_photo.png -->
                                <label for="user_photo"
                                    class="form-label position-absolute top-50 start-50 translate-middle"
