...
class TeamsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Team::create(['name' => 'G2', 'league_id'=>2, 'logo' => 'teams_logo/G2_logo.png', 'team_photo' => 'teams/g2_team.jpg']);
        Team::create(['name' => 'Fnatic', 'league_id'=>2, 'logo' => 'teams_logo/Fnatic_logo.png', 'team_photo' => 'teams/fnatic_team.jpg']);
        Team::create(['name' => 'KOI', 'league_id'=>2, 'logo' => 'teams_logo/KOI_logo.png', 'team_photo' => 'teams/koi_team.jpg']);
        Team::create(['name' => 'Heretics', 'league_id'=>2, 'logo' => 'teams_logo/Heretics_logo.png', 'team_photo' => 'teams/heretics_team.jpg']);
        Team::create(['name' => 'Kcorp', 'league_id'=>2, 'logo' => 'teams_logo/Kcorp_logo.png', 'team_photo' => 'teams/kcorp_team.jpg']);
        Team::create(['name' => 'BDS', 'league_id'=>2, 'logo' => 'teams_logo/BDS_logo.png', 'team_photo' => 'teams/bds_team.jpg']);
        Team::create(['name' => 'Rogue', 'league_id'=>2, 'logo' => 'teams_logo/Rogue_logo.png', 'team_photo' => 'teams/rogue_team.jpg']);
        Team::create(['name' => 'Giantx', 'league_id'=>2, 'logo' => 'teams_logo/Giantx_logo.png', 'team_photo' => 'teams/giantx_team.jpg']);
        Team::create(['name' => 'Vitality', 'league_id'=>2, 'logo' => 'teams_logo/Vitality_logo.png', 'team_photo' => 'teams/vitality_team.jpg']);
        Team::create(['name' => 'SK', 'league_id'=>2, 'logo' => 'teams_logo/SK_logo.png', 'team_photo' => 'teams/sk_team.jpg']);
